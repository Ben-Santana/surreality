...
const fields = [
  ...
  ["minimumAppVersion", "string", "Optional. Informational minimum host version. Not enforced by version 2."],
  ...
  ["entrypoints", "paths", "Required. mapping is required. inspector, runtime, and plugin are optional relative paths. plugin requires version 2 and system:unrestricted."],
