...
import type { CloudState, CommunityBrowseOptions, CommunityBrowseResult, CommunityPackageTag, CommunityProgress, CommunityRelease, CustomMappingPackageManifest } from "../src/types";
...
export class CloudService {
  ...
  private release(row:JsonRecord,publisher="you"){
    ...
    return{
      ...
      ...(Array.isArray(row.listing_tags)?{listingTags:row.listing_tags.filter((tag):tag is CommunityPackageTag=>typeof tag==="string"&&["media","games","audio","visuals","tools"].includes(tag))}:{}),
